...
function display(n) {
  ...
  if (turnNo < 9 && cellid === null && WinnerClass == null) {
    //cellid ===null condition so that each mark is in unique box
    if (turnNo % 2 == 0) {
      turnNo++;
      div.textContent = "X";
  ...
  if (turnNo > 4 && turnNo < 9 && WinnerClass == null) {
    ...
    if (
      gameboard[0].move == mark &&
      gameboard[4].move == mark &&
      gameboard[8].move == mark
    ) {
      Winner(gameboard[4].move, [1, 5, 9]);
    }
    if (
      gameboard[0].move == mark &&
      gameboard[1].move == mark &&
      gameboard[2].move == mark
    ) {
      Winner(gameboard[1].move, [1, 2, 3]);
    }
    if (
      gameboard[0].move == mark &&
      gameboard[3].move == mark &&
      gameboard[6].move == mark
    ) {
      Winner(gameboard[3].move, [1, 4, 7]);
    }
    if (
      gameboard[2].move == mark4 &&
      gameboard[4].move == mark4 &&
      gameboard[6].move == mark4
    ) {
      Winner(gameboard[4].move, [3, 5, 7]);
    }
    if (
      gameboard[2].move == mark2 &&
      gameboard[5].move == mark2 &&
      gameboard[8].move == mark2
    ) {
      Winner(gameboard[2].move, [3, 6, 9]);
    }
    if (
      gameboard[1].move == mark4 &&
      gameboard[4].move == mark4 &&
      gameboard[7].move == mark4
    ) {
      Winner(gameboard[1].move, [2, 5, 8]);
    }
    if (
      gameboard[6].move == mark3 &&
      gameboard[7].move == mark3 &&
      gameboard[8].move == mark3
    ) {
      Winner(gameboard[7].move, [7, 8, 9]);
    }
    if (
      gameboard[5].move == mark4 &&
      gameboard[4].move == mark4 &&
      gameboard[3].move == mark4
    ) {
